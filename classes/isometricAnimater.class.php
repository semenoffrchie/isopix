...
class isometricAnimater {
	 ...
	 * $isometricController: The isometricController object.
	 **/
	function addFrame($isometricController) {
		ob_start();
			$isometricController->renderImage(-2, null, false);
	 ...
	 * renderImage();
	 **
	 * Renders the final animated image.
	 **/
	function renderImage() {
		$outputImage = new _gifMerge($this->_frames, 255,255,255, 0, 500, 0,0,"C_MEMORY");
		header("Content-Type: image/gif");
		print $outputImage->getAnimation();
		return;
	}
}
/**
 * Below is the 3rd party UNDOCUMENTED class.
 **/
class _gifMerge
{
	var $ver							= '1.1';
	...
	function _gifMerge($images, $t1, $t2, $t3, $loop, $dl, $xpos, $ypos, $model, $debug = false)
	{
